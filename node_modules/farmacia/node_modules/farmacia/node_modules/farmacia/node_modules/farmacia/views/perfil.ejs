...
<head>
  ...
  <title>Mi Perfil | Farmacia Salud Total</title>
...
<body>
  <header>
    ...
    <div class="icons">
      <a href="/menu"><i class="fas fa-home"></i></a>
  ...
  <main>
    <div class="profile-card">
      ...
      <% } else { %>
        <img src="https://ui-avatars.com/api/?name=<%= encodeURIComponent(usuario.nombre) %>&background=00796b&color=ffffff&rounded=true&size=120" alt="Foto de perfil" class="profile-img">
      <% } %>
      ...
      <div class="edit-btn">
        <button onclick="window.location.href='/editar-perfil'">
